...
class TestAESKeyWrap(object):
    @pytest.mark.supported(
        ...
        skip_message="Does not support AES key wrap (RFC 3394) because AES-ECB is unsupported",
    )
...
@pytest.mark.supported(
    ...
    skip_message="Does not support AES key wrap (RFC 5649) because AES-ECB is unsupported",
)
