...
def test_encode_point():
    ...
    assert data == binascii.unhexlify(
        "04233ea3b0027127084cd2cd336a13aeef69c598d8af61369a36454a17c6c22aec3ea2c10a84153862be4ec82940f0543f9ba866af9751a6ee79d38460b35f442e"
    )
...
def test_from_encoded_point_invalid_length():
    bad_data = binascii.unhexlify(
        "04233ea3b0027127084cd2cd336a13aeef69c598d8af61369a36454a17c6c22aec3ea2c10a84153862be4ec82940f0543f9ba866af9751a6ee79d38460"
    )
    with pytest.raises(ValueError):
        with pytest.warns(CryptographyDeprecationWarning):
...
class TestECDSAVectors(object):
    ...
    def test_load_invalid_public_ec_key_from_numbers(self, backend):
        ...
        numbers = ec.EllipticCurvePublicNumbers(
            int(
                "000003647356b91f8ace114c7247ecf4f4a622553fc025e04a178f179ef279090c184af678a4c78f635483bdd8aa544851c6ef291c1f0d6a241ebfd14577d1d30d9903ce",
                16,
            ),
            int(
                "000001499bc7e079322ea0fcfbd6b40103fa6a1536c2257b182db0df4b3696ec643adf100eb4f2025d1b873f82e5a475d6e4400ba777090eeb4563a11509e4c87319dc26",
                16,
            ),
            ec.SECP521R1(),
        )
        ...
        numbers = ec.EllipticCurvePublicNumbers(
            int(
                "0000019aadc221cc0525118ab6d5aa1f64720603de0be128cbfea0b381ad802a2facc6370bb58cf88b3f0c692bc654ee19d6cad198f10d4b681b396f20d2e40603fa945b",
                16,
            ),
            int(
                "0000025da392803a320717a08d4cb3dea932039badff363b71bdb8064e7266c7f4f4b748d4d425347fc33e3885d34b750fa7fcd5691f4d90c89522ce33feff5db10088a5",
                16,
            ),
            ec.SECP521R1(),
        )
...
class TestEllipticCurvePEMPublicKeySerialization(object):
    ...
    def test_public_bytes_openssh(self, backend):
        ...
        assert (
            ssh_bytes
            == b"ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBCS8827s9rUZyxZTi/um01+oIlWrwLHOjQxRU9CDAndom00zVAw5BRrIKtHB+SWD4P+sVJTARSq1mHt8kOIWrPc="
        )
    ...
    def test_from_encoded_point_notoncurve(self):
        uncompressed_point = binascii.unhexlify(
            "047399336a9edf2197c2f8eb3d39aed9c34a66e45d918a07dc7684c42c9b37ac686699ececc4f5f0d756d3c450708a0694eb0a07a68b805070b40b058d27271f6e"
        )
        with pytest.raises(ValueError):
    ...
    def test_from_encoded_point_uncompressed(self):
        uncompressed_point = binascii.unhexlify(
            "047399336a9edf2197c2f8eb3d39aed9c34a66e45d918a07dc7684c42c9b37ac686699ececc4f5f0d756d3c450708a0694eb0a07a68b805070b40b058d27271f6d"
        )
    ...
    def test_from_encoded_point_unsupported_encoding(self):
        unsupported_type = binascii.unhexlify(
            "057399336a9edf2197c2f8eb3d39aed9c34a66e45d918a07dc7684c42c9b37ac68"
        )
        with pytest.raises(ValueError):
            ec.EllipticCurvePublicKey.from_encoded_point(
                ec.SECP256R1(), unsupported_type
