...
class TestDSANumbers(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(public_numbers)
            == "<DSAPublicNumbers(y=4, parameter_numbers=<DSAParameterNumbers(p=1, q=2, g=3)>)>"
        )
