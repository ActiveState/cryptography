...
def _skip_fips_format(key_path, password, backend):
    if backend._fips_enabled:
        ...
        if (
            ...
            pytest.skip(
                "The encrypted PEM vectors currently have encryption that is not FIPS approved in the 3.0 provider"
            )
        if key_path[0] == "DER_Serialization" and password is not None:
            pytest.skip(
                "The encrypted PKCS8 DER vectors currently have encryption that is not FIPS approved in the 3.0 provider"
            )
...
class TestPEMSerialization(object):
    ...
    def test_rsa_traditional_encrypted_values(self, backend):
        ...
        assert numbers.d == int(
            "db4848c36f478dd5d38f35ae519643b6b810d404bcb76c00e44015e56ca1cab07bb7ae91f6b4b43fcfc82a47d7ed55b8c575152116994c2ce5325ec24313b911",
            16,
        )
        ...
        assert numbers.public_numbers.n == int(
            "dba786074f2f0350ce1d99f5aed5b520cfe0deb5429ec8f2a88563763f566e779814b7c310e5326edae31198eed439b845dd2db99eaa60f5c16a43f4be6bcf37",
            16,
        )
    ...
    def test_rsa_pkcs8_encrypted_values(self, backend):
        ...
        numbers = pkey.private_numbers()
        assert numbers.public_numbers.n == int(
            "",
            16,
        )
        assert numbers.public_numbers.e == 65537
        assert numbers.d == int(
            "",
            16,
        )
        assert numbers.p == int(
            "00db122ac857b2c0437d7616daa98e597bb75ca9ad3a47a70bec10c1003603328794b225c8e3eee6ffd3fd6d2253d28e071fe27d629ab072faa14377ce6118cb67",
            16,
        )
        assert numbers.q == int(
            "00df1b8aa8506fcbbbb9d00257f2975e38b33d2698fd0f37e82d7ef38c56f21b6ced63c825383782a7115cfcc093300987dbd2853b518d1c8f26382a2d2586d391",
            16,
        )
        assert numbers.dmp1 == int(
            "00be18aca13e60712fdf5daa85421eb10d86d654b269e1255656194fb0c42dd01a1070ea12c19f5c39e09587af02f7b1a1030d016a9ffabf3b36d699ceaf38d9bf",
            16,
        )
        assert numbers.dmq1 == int(
            "71aa8978f90a0c050744b77cf1263725b203ac9f730606d8ae1d289dce4a28b8d534e9ea347aeb808c73107e583eb80c546d2bddadcdb3c82693a4c13d863451",
            16,
        )
        assert numbers.iqmp == int(
            "136b7b1afac6e6279f71b24217b7083485a5e827d156024609dae39d48a6bdb55af2f062cc4a3b077434e6fffad5faa29a2b5dba2bed3e4621e478c097ccfe7f",
            16,
        )
    ...
    def test_load_pem_dsa_private_key(self, backend):
        ...
        assert pub.y == int(
            "",
            16,
        )
        assert parameter_numbers.p == int(
            "",
            16,
        )
        ...
        assert parameter_numbers.g == int(
            "",
            16,
        )
...
class TestRSASSHSerialization(object):
    ...
    def test_load_ssh_public_key_rsa(self, backend):
        ...
        expected_e = 65537
        expected_n = int(
            "",
            16,
        )
...
class TestDSSSSHSerialization(object):
    ...
    def test_load_ssh_public_key_dss(self, backend):
        ...
        numbers = key.public_numbers()
        expected_y = int(
            "d143cf92901f936fa258e9a11422460c8f8f1597884eef8cb1252a3e2ff0aae96a7032c01cdd8485b5cbfb73a46bb04708f98a18bc88d4c7812b284da8f9006e473e89897f9bc9125c69bbfd8ef691c0e76c1c34e6c843b8fe240e6e5aeb313486e5fa917ab1288ff1a6ebcf9dcdeed3c5fc88474e30476f53a5ec816ef69f4",
            16,
        )
        expected_p = int(
            "",
            16,
        )
        expected_q = 1230879958723280233885494314531920096931919647917
        expected_g = int(
            "",
            16,
        )
...
class TestECDSASSHSerialization(object):
    def test_load_ssh_public_key_ecdsa_nist_p256(self, backend):
        ...
        assert isinstance(key, ec.EllipticCurvePublicKey)
        expected_x = int(
            "44196257377740326295529888716212621920056478823906609851236662550785814128027",
            10,
        )
        expected_y = int(
            "12257763433170736656417248739355923610241609728032203358057767672925775019611",
            10,
        )
    ...
    def test_load_ssh_public_key_ecdsa_nist_p384(self, backend):
        ...
        assert isinstance(key, ec.EllipticCurvePublicKey)
        expected_x = int(
            "31541830871345183397582554827482786756220448716666815789487537666592636882822352575507883817901562613492450642523901",
            10,
        )
        expected_y = int(
            "15111413269431823234030344298767984698884955023183354737123929430995703524272335782455051101616329050844273733614670",
            10,
        )
        assert key.public_numbers() == ec.EllipticCurvePublicNumbers(
    ...
    def test_load_ssh_public_key_ecdsa_nist_p521(self, backend):
        ...
        assert isinstance(key, ec.EllipticCurvePublicKey)
        expected_x = int(
            "5412412312017818959884262257523090402737631336974246727934641521977809037378785192537810367028427387173980786968395921877911964629142163122798974160187785455",
            10,
        )
        expected_y = int(
            "1611177512284503320093869406238182095744184301484912566001130357915284560361402515564433711416776946492019498546572162801954089916006665939539407104638103918",
            10,
        )
        assert key.public_numbers() == ec.EllipticCurvePublicNumbers(
...
class TestEd25519SSHSerialization(object):
    def test_load_ssh_public_key(self, backend):
        ...
        assert (
            ...
            == b"m\x9f\x82\x99\xa9`\xee\xb5\xa9\xe01\x19\xdd0\x81\x16\x8d\xfcN\x06G\xecV\xbc\x19\xaf\xc6<k\x07[\xc6"
        )
...
class TestOpenSSHSerialization(object):
    ...
    def test_fraglist_corners(self):
        ...
        assert (
            f.tobytes()
            == b"\x00\x00\x00\x00" + b"\x00\x00\x00\x02" + b"\x00\x80"
        )
