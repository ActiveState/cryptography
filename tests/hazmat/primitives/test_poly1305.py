...
class TestPoly1305(object):
    ...
    def test_buffer_protocol(self, backend):
        ...
        msg = binascii.unhexlify(
            b"2754776173206272696c6c69672c20616e642074686520736c6974687920746f7665730a446964206779726520616e642067696d626c6520696e2074686520776162653a0a416c6c206d696d737920776572652074686520626f726f676f7665732c0a416e6420746865206d6f6d65207261746873206f757467726162652e"
        )
        key = bytearray(key)
        poly = Poly1305(key)
