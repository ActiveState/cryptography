...
class TestUnrecognizedExtension(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(ext1)
            == "<UnrecognizedExtension(oid=<ObjectIdentifier(oid=1.2.3.4, name=Unknown OID)>, value=b'\\x03\\x02\\x01')>"
        )
...
class TestUserNotice(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(un)
            == "<UserNotice(notice_reference=<NoticeReference(organization='org', notice_numbers=[1])>, explicit_text='text')>"
        )
...
class TestPolicyInformation(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(pi)
            == "<PolicyInformation(policy_identifier=<ObjectIdentifier(oid=1.2.3, name=Unknown OID)>, policy_qualifiers=['string', <UserNotice(notice_reference=None, explicit_text='hi')>])>"
        )
...
class TestCertificatePolicies(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(cp)
            == "<CertificatePolicies([<PolicyInformation(policy_identifier=<ObjectIdentifier(oid=1.2.3, name=Unknown OID)>, policy_qualifiers=['string'])>])>"
        )
...
class TestKeyUsage(object):
    ...
    def test_repr_key_agreement_false(self):
        ...
        assert (
            repr(ku)
            == "<KeyUsage(digital_signature=True, content_commitment=True, key_encipherment=False, data_encipherment=False, key_agreement=False, key_cert_sign=True, crl_sign=False, encipher_only=False, decipher_only=False)>"
        )
    ...
    def test_repr_key_agreement_true(self):
        ...
        assert (
            repr(ku)
            == "<KeyUsage(digital_signature=True, content_commitment=True, key_encipherment=False, data_encipherment=False, key_agreement=True, key_cert_sign=True, crl_sign=False, encipher_only=False, decipher_only=False)>"
        )
...
class TestSubjectKeyIdentifier(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(ext)
            == "<Extension(oid=<ObjectIdentifier(oid=2.5.29.14, name=subjectKeyIdentifier)>, critical=False, value=<SubjectKeyIdentifier(digest=b'\\t#\\x84\\x93\"0I\\x8b\\xc9\\x80\\xaa\\x80\\x98Eoo\\xf7\\xff:\\xc9')>)>"
        )
...
class TestAuthorityKeyIdentifier(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(aki)
            == "<AuthorityKeyIdentifier(key_identifier=b'digest', authority_cert_issuer=[<DirectoryName(value=<Name(CN=myCN)>)>], authority_cert_serial_number=1234)>"
        )
...
class TestExtendedKeyUsage(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(eku)
            == "<ExtendedKeyUsage([<ObjectIdentifier(oid=1.3.6.1.5.5.7.3.1, name=serverAuth)>, <ObjectIdentifier(oid=1.3.6.1.5.5.7.3.2, name=clientAuth)>])>"
        )
...
class TestExtensions(object):
    ...
    def test_repr(self, backend):
        ...
        assert (
            repr(cert.extensions)
            == "<Extensions([<Extension(oid=<ObjectIdentifier(oid=2.5.29.19, name=basicConstraints)>, critical=False, value=<BasicConstraints(ca=False, path_length=None)>)>])>"
        )
...
class TestOtherName(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(gn)
            == "<OtherName(type_id=<ObjectIdentifier(oid=1.2.3.4, name=Unknown OID)>, value=b'derdata')>"
        )
        gn = x509.OtherName(x509.ObjectIdentifier("2.5.4.65"), b"derdata")
        assert (
            repr(gn)
            == "<OtherName(type_id=<ObjectIdentifier(oid=2.5.4.65, name=pseudonym)>, value=b'derdata')>"
        )
...
class TestGeneralNames(object):
    ...
    def test_repr(self):
        gns = x509.GeneralNames([x509.DNSName("cryptography.io")])
        assert (
            repr(gns) == "<GeneralNames([<DNSName(value='cryptography.io')>])>"
        )
...
class TestIssuerAlternativeName(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(san)
            == "<IssuerAlternativeName(<GeneralNames([<DNSName(value='cryptography.io')>])>)>"
        )
...
class TestSubjectAlternativeName(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(san)
            == "<SubjectAlternativeName(<GeneralNames([<DNSName(value='cryptography.io')>])>)>"
        )
...
class TestAccessDescription(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(ad)
            == "<AccessDescription(access_method=<ObjectIdentifier(oid=1.3.6.1.5.5.7.48.1, name=OCSP)>, access_location=<UniformResourceIdentifier(value='http://ocsp.domain.com')>)>"
        )
...
class TestPolicyConstraints(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(pc)
            == "<PolicyConstraints(require_explicit_policy=0, inhibit_policy_mapping=None)>"
        )
...
class TestSubjectInformationAccess(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(sia)
            == "<SubjectInformationAccess([<AccessDescription(access_method=<ObjectIdentifier(oid=1.3.6.1.5.5.7.48.5, name=caRepository)>, access_location=<UniformResourceIdentifier(value='http://ca.domain.com')>)>])>"
        )
...
class TestNameConstraints(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(nc)
            == "<NameConstraints(permitted_subtrees=[<DNSName(value='name.local')>, <DNSName(value='name2.local')>], excluded_subtrees=None)>"
        )
...
class TestDistributionPoint(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(dp)
            == "<DistributionPoint(full_name=None, relative_name=<RelativeDistinguishedName(CN=myCN)>, reasons=frozenset({<ReasonFlags.ca_compromise: 'cACompromise'>}), crl_issuer=[<DirectoryName(value=<Name(CN=Important CA)>)>])>"
        )
...
class TestFreshestCRL(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(fcrl)
            == "<FreshestCRL([<DistributionPoint(full_name=[<UniformResourceIdentifier(value='ftp://domain')>], relative_name=None, reasons=frozenset({<ReasonFlags.key_compromise: 'keyCompromise'>}), crl_issuer=None)>])>"
        )
...
class TestCRLDistributionPoints(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(cdp)
            == "<CRLDistributionPoints([<DistributionPoint(full_name=[<UniformResourceIdentifier(value='ftp://domain')>], relative_name=None, reasons=frozenset({<ReasonFlags.key_compromise: 'keyCompromise'>}), crl_issuer=None)>])>"
        )
...
class TestIssuingDistributionPointExtension(object):
    ...
    def test_repr(self):
        ...
        assert (
            repr(idp)
            == "<IssuingDistributionPoint(full_name=None, relative_name=None, only_contains_user_certs=False, only_contains_ca_certs=False, only_some_reasons=frozenset({<ReasonFlags.key_compromise: 'keyCompromise'>}), indirect_crl=False, only_contains_attribute_certs=False)>"
        )
...
class TestPrecertificateSignedCertificateTimestampsExtension(object):
    ...
    def test_repr(self):
        assert (
            repr(x509.PrecertificateSignedCertificateTimestamps([]))
    ...
    def test_simple(self, backend):
        ...
        assert (
            sct.log_id
            == b"\xa7\xceJNb\x07\xe0\xad\xde\xe5\xfd\xaaK\x1f\x86v\x87g\xb5\xd0\x02\xa5]G1\x0e~g\n\x95\xea\xb2"
        )
