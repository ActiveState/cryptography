...
class BrainpoolP512R1(EllipticCurve):
    ...
    key_size = 512
_CURVE_TYPES: typing.Dict[str, typing.Type[EllipticCurve]] = {'prime192v1': SECP192R1, 'prime256v1': SECP256R1, 'secp192r1': SECP192R1, 'secp224r1': SECP224R1, 'secp256r1': SECP256R1, 'secp384r1': SECP384R1, 'secp521r1': SECP521R1, 'secp256k1': SECP256K1, 'sect163k1': SECT163K1, 'sect233k1': SECT233K1, 'sect283k1': SECT283K1, 'sect409k1': SECT409K1, 'sect571k1': SECT571K1, 'sect163r2': SECT163R2, 'sect233r1': SECT233R1, 'sect283r1': SECT283R1, 'sect409r1': SECT409R1, 'sect571r1': SECT571R1, 'brainpoolP256r1': BrainpoolP256R1, 'brainpoolP384r1': BrainpoolP384R1, 'brainpoolP512r1': BrainpoolP512R1}
...
class EllipticCurvePublicNumbers(object):
    ...
    def encode_point(self):
        warnings.warn('encode_point has been deprecated on EllipticCurvePublicNumbers and will be removed in a future version. Please use EllipticCurvePublicKey.public_bytes to obtain both compressed and uncompressed point encoding.', utils.PersistentlyDeprecated2019, stacklevel=2)
    ...
    def from_encoded_point(cls, curve, data):
        if not isinstance(curve, EllipticCurve):
            raise TypeError('curve must be an EllipticCurve instance')
        warnings.warn('Support for unsafe construction of public numbers from encoded data will be removed in a future version. Please use EllipticCurvePublicKey.from_encoded_point', utils.PersistentlyDeprecated2019, stacklevel=2)
