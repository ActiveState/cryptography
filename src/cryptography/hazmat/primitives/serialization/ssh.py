...
try:
    ...
    def _bcrypt_kdf(password, salt, desired_key_bytes, rounds, ignore_few_rounds=False):
...
_SSH_CIPHERS = {b'aes256-ctr': (algorithms.AES, 32, modes.CTR, 16), b'aes256-cbc': (algorithms.AES, 32, modes.CBC, 16)}
# map local curve name to key type
_ECDSA_KEY_TYPE = {'secp256r1': _ECDSA_NISTP256, 'secp384r1': _ECDSA_NISTP384, 'secp521r1': _ECDSA_NISTP521}
...
_KEY_FORMATS = {_SSH_RSA: _SSHFormatRSA(), _SSH_DSA: _SSHFormatDSA(), _SSH_ED25519: _SSHFormatEd25519(), _ECDSA_NISTP256: _SSHFormatECDSA(b'nistp256', ec.SECP256R1()), _ECDSA_NISTP384: _SSHFormatECDSA(b'nistp384', ec.SECP384R1()), _ECDSA_NISTP521: _SSHFormatECDSA(b'nistp521', ec.SECP521R1())}
...
_SSH_PRIVATE_KEY_TYPES = typing.Union[ec.EllipticCurvePrivateKey, rsa.RSAPrivateKey, dsa.DSAPrivateKey, ed25519.Ed25519PrivateKey]
...
def serialize_ssh_private_key(private_key, password=None):
    ...
    return txt
_SSH_PUBLIC_KEY_TYPES = typing.Union[ec.EllipticCurvePublicKey, rsa.RSAPublicKey, dsa.DSAPublicKey, ed25519.Ed25519PublicKey]
