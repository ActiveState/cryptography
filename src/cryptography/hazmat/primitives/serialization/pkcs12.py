...
_ALLOWED_PKCS12_TYPES = typing.Union[rsa.RSAPrivateKey, dsa.DSAPrivateKey, ec.EllipticCurvePrivateKey]
...
def serialize_key_and_certificates(name, key, cert, cas, encryption_algorithm):
    if key is not None and (not isinstance(key, (rsa.RSAPrivateKey, dsa.DSAPrivateKey, ec.EllipticCurvePrivateKey))):
