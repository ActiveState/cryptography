...
def cryptography_has_ec2m():
    return ['EC_POINT_get_affine_coordinates_GF2m']
...
def cryptography_has_tlsv13():
    return ['TLS1_3_VERSION', 'SSL_OP_NO_TLSv1_3', 'SSL_VERIFY_POST_HANDSHAKE', 'SSL_CTX_set_ciphersuites', 'SSL_verify_client_post_handshake', 'SSL_CTX_set_post_handshake_auth', 'SSL_set_post_handshake_auth', 'SSL_SESSION_get_max_early_data', 'SSL_write_early_data', 'SSL_read_early_data', 'SSL_CTX_set_max_early_data']
...
def cryptography_has_engine():
    return ['ENGINE_by_id', 'ENGINE_init', 'ENGINE_finish', 'ENGINE_get_default_RAND', 'ENGINE_set_default_RAND', 'ENGINE_unregister_RAND', 'ENGINE_ctrl_cmd', 'ENGINE_free', 'ENGINE_get_name', 'Cryptography_add_osrandom_engine', 'ENGINE_ctrl_cmd_string', 'ENGINE_load_builtin_engines', 'ENGINE_load_private_key', 'ENGINE_load_public_key']
...
def cryptography_has_get_proto_version():
    return ['SSL_CTX_get_min_proto_version', 'SSL_CTX_get_max_proto_version', 'SSL_get_min_proto_version', 'SSL_get_max_proto_version']
