    ...
    def __init__(self, backend, cipher, mode, operation):
        ...
        try:
            ...
            raise UnsupportedAlgorithm(
                "cipher {} in {} mode is not supported by this backend.".format(
        ...
        if evp_cipher == self._backend._ffi.NULL:
            ...
            msg += "is not supported by this backend (Your version of OpenSSL may be too old. Current version: {}.)".format(
