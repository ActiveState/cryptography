...
if typing.TYPE_CHECKING:
    ...
    class _RegisterDecoratorType(Protocol):
        ...
        def __call__(self, klass, *, check_annotations: bool=False):
            ...

def register_interface(iface):

    def register_decorator(klass: '_T_class', *, check_annotations: bool=False) -> '_T_class':
...
def deprecated(value, module_name, message, warning_class):
    ...
    if not isinstance(module, _ModuleWithDeprecations):
        sys.modules[module_name] = _ModuleWithDeprecations(module)  # type: ignore[assignment]
